...
export type SimilarCollectionsResponse = z.infer<
	typeof similarCollectionsResponseSchema
>;
...
export type CollectionsListDetailed = z.infer<
	typeof collectionsListSchemaDetailed
>;
