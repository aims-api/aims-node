...
const pathArtists = `${API_HOST}/${API_VERSION}/artists/similar/by-key`
const pathAlbums = `${API_HOST}/${API_VERSION}/albums/similar/by-key`
const pathPlaylist = `${API_HOST}/${API_VERSION}/playlist/similar/by-key`
...
describe('Search similar by id', () => {
  ...
  describe('Artists', () => {
    test('success, return data', async () => {
      ...
      const response = await testClient.endpoints.artist.searchSimilar.byKey({
        data: {
          key: '123',
        },
        params: {
  ...
  describe('Albums', () => {
    test('success, return data', async () => {
      mockServerBodyData(200)
      const response = await testClient.endpoints.album.searchSimilar.byKey({
        data: {
          key: '123',
          group_id: 'group_id',
        },
  ...
  describe('Playlist', () => {
    test('success, return data', async () => {
      mockServerBodyData(200)
      const response = await testClient.endpoints.playlist.searchSimilar.byKey({
        data: {
          key: '123',
        },
        params: {
